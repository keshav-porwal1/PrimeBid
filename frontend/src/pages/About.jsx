...
const About = () => {
  ...
  return (
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center dark:bg-gray-950 dark:text-white">
      <div>
        <h1 className="text-[#d6482b] text-2xl font-bold mb-8 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl">
          About Us
        </h1>
        
        <p className="text-xl mt-4 text-stone-600 dark:text-gray-300">
          Welcome to PrimeBid, the ultimate destination for online auctions and
          bidding excitement. Founded in 2025, we are dedicated to providing a
      ...
      <div>
        ...
        <ul className="list-inside">
          {values.map((element) => (
            <li
              className="text-xl text-stone-600 dark:text-gray-300 mb-2"
              key={element.id}
            >
      ...
      <div>
        ...
        <p className="text-xl text-stone-600 dark:text-gray-300">
          Founded by Keshav Porwal, PrimeBid was born out of a passion for
          connecting people with unique and valuable items. Our team is committed to creating
