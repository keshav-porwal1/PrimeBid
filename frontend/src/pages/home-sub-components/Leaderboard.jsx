    ...
    <>
      <section className="my-8 lg:px-5">
        <div className="flex flex-col min-[340px]:flex-row min-[340px]:gap-2">
          <h3 className="text-[#111] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl dark:text-white">
            Top 10
          </h3>
      ...
      <table className="min-w-full border my-5 border-gray-300 bg-white dark:bg-gray-800">
        <thead>
        <tr>
          <th className="py-2 px-4 text-left text-gray-900 dark:text-gray-100">Profile Pic</th>
          <th className="py-2 px-4 text-left text-gray-900 dark:text-gray-100">Username</th>
          <th className="py-2 px-4 text-left text-gray-900 dark:text-gray-100">Bid Expenditure</th>
          <th className="py-2 px-4 text-left text-gray-900 dark:text-gray-100">Auctions Won</th>
        </tr>
      </thead>
